...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <form name="payment" action="pagar.php" method="post">
	    <input type="radio" name="paymethod" value="Paypal" checked="checked"> Paypal
		<br /><br />
		<div class="alert alert-success">
		<div class="from-gruop">
			<label for="my-input">Correo de contacto:</label>
			<input type="email" name="email" class="from-group" type="email" placeholder="Escriba su correo Paypal" required>
		</div>
		<small id="emailHelp" class="form"> Los productos se enviaran a este correo</small>
		</div>
